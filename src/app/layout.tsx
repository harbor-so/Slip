...
import { TopHeader } from "@web/shell/TopHeader.js";
...
/**
 * The shell: a top titlebar, a fixed left sidebar, and one scrolling column,
 * recreated from the reference demo. The server component does the privileged
 * reads (org + connectors) and hands them to the client chrome; the drifting-orb
